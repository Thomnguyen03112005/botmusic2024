import Discord, { ActionRowBuilder, ButtonBuilder, ModalBuilder, TextInputBuilder, ChannelType, TextInputStyle, ComponentType } from "discord.js";
import * as Giveaways from "discord-giveaways";
...
const GiveawayManagerWithOwnDatabase = class extends Giveaways.GiveawaysManager {
  constructor(client) {
    super(client, {
